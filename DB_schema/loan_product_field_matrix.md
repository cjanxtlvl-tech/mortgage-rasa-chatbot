# Loan Product Field Matrix

This matrix defines which fields are expected for each loan product in the lead-generation funnel. Use it when implementing forms, chatbot flows, API payload validation, and database models.
...
| Field | Purchase | Refinance | Government | Jumbo | Investment | Hard Money | SBA | Commercial |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| lead_id | ● | ● | ● | ● | ● | ● | ● | ● |
| created_at | ● | ● | ● | ● | ● | ● | ● | ● |
| product_type | ● | ● | ● | ● | ● | ● | ● | ● |
